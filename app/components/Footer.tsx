    ...
    <footer className="py-20 bg-secondary border-t border-border transition-colors duration-500">
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-text-muted text-sm leading-relaxed max-w-sm mb-10">
              VigIA democratiza el acceso a la ley colombiana. Nuestra misión es
              empoderar al ciudadano con conocimiento real para prevenir abusos
              en la vía y garantizar el debido proceso.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="font-bold text-sm uppercase tracking-widest mb-8 text-text-main">
              Navegación
            </h4>
            <ul className="space-y-4">
              <li>
                <Link
                  href="#hero"
                  className="text-text-muted hover:text-blue-600 dark:hover:text-blue-500 transition-colors font-medium"
                >
                  Inicio
                </Link>
              </li>
          ...
          <div>
            ...
            <p className="text-xs text-text-muted leading-relaxed font-medium italic">
              VigIA es una herramienta informativa técnica. No reemplaza la
              asesoría personalizada de un abogado profesional colegiado.
            </p>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-4 text-[11px] font-black uppercase tracking-[0.2em] text-text-muted">
            <Link
            ...
            <Link
              href="/legal/politica-tratamiento-datos"
              className="hover:text-blue-600 dark:hover:text-blue-500 transition-colors"
            >
              Datos
            </Link>
